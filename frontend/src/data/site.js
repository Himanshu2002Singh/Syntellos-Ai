...
export const offerings = [
  {
    ...
    text: "Knowledge assistants, workflow agents and document intelligence designed around accountable enterprise work.",
    icon: BrainCircuit,
    image: "/media/images/thirdeye-genai-services.png",
    imageAlt: "Illustration of connected generative AI systems",
  },
  {
    group: "Physical intelligence",
    title: "Robotics & automation",
    text: "Automation systems for material movement, warehouse operations and repeatable frontline work.",
    icon: Bot,
    image: "/media/images/addverb-mobile-robots.webp",
    imageAlt: "Autonomous mobile robots working in a warehouse",
  },
  {
    group: "Physical intelligence",
    title: "Internet of Things",
    text: "Connected assets, live operational data and earlier signals from the places that matter.",
    icon: RadioTower,
    image: "/media/images/thirdeye-predictive-maintenance.jpg",
    imageAlt: "Maintenance team monitoring connected industrial equipment",
  },
  {
    group: "Seeing & training",
    title: "Computer vision",
    text: "Inspection, safety and visual intelligence for decisions that happen on the ground.",
    icon: ScanLine,
    image: "/media/images/thirdeye-inventory-management.jpg",
    imageAlt: "Worker using a tablet to inspect inventory",
  },
  {
    group: "Seeing & training",
    title: "AR / VR / XR",
    text: "Immersive systems for remote assistance, technical training and spatial product experiences.",
    icon: Glasses,
  ...
  {
    group: "Learning",
    title: "Labs & upskilling",
    text: "Practical technology labs, faculty enablement and hands-on learning programmes.",
    icon: GraduationCap,
    image: "/media/images/xterra-robot-03.webp",
    imageAlt: "Learner using a VR headset beside an industrial robot",
  },
];
...
export const leasingOptions = [
  {
    ...
    imageAlt: "Addverb Travect warehouse automation system",
  },
  {
  ...
  },
  {
    ...
    imageAlt: "Customer behaviour analysis in a retail environment",
  },
  {
...
export const ecosystemPartners = [
  {
    ...
    text: "Automation systems for material movement and warehouse operations.",
    image: "/media/images/addverb-dynamo.jpg",
    imageAlt: "Addverb robots operating in a warehouse",
  },
  {
    name: "ThirdEye Data",
